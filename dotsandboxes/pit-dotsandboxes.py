...
from dotsandboxes.DotsAndBoxesPlayers import HumanDotsAndBoxesPlayer, RandomPlayer, GreedyRandomPlayer, HeuristicDotsAndBoxesPlayer
from dotsandboxes.pytorch.NNet import NNetWrapper


g = DotsAndBoxesGame(n=3)

p2 = HeuristicDotsAndBoxesPlayer(g).play()

numMCTSSims = 20
n1 = NNetWrapper(g)
n1.load_checkpoint("./temp_min/best.pth.tar")
